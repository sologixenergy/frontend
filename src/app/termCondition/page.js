...
const page = () => {
  return (
    ...
    <div className="border-gray-500 w-11/12 m-auto">
      <p className="font-bold text-2xl underline tracking-wider text-center">Terms & Conditions</p>
      <br></br>
      <p>
      ...
      <p>
        ...
        and Terms of Use for access or usage of domain name www.
        sologixenergy.com ('Website'), including the related mobile site and
        mobile application (hereinafter referred to as 'Platform').
      </p>
      <br></br>
      <p>
        3. The Platform is owned by Sologix energy private limited, a company
        incorporated under the Companies Act, 1956 with its registered office at
        143 D Chuttu Road Neuri Nimtand Colony Ranchi ,India (hereinafter
      ...
      <p>
        ...
        constitute Your binding obligations, with Platform Owner. These Terms of
        Use relate to your use of our website, goods (as applicable) or services
        (as applicable) (collectively, 'Services'). Any terms and conditions
      ...
      <br></br>
      <p>
        7. The use of Platform and/or availing of our Services is subject to the
      ...
      <br></br>
      <p>
        2. Neither we nor any third parties provide any warranty or guarantee as
      ...
      <br></br>
      <p>
        3. Your use of our Services and the Platform is solely and entirely at
        your own risk and discretion for which we shall not be liable to you in
        any manner. You are required to independently assess and ensure that the
        Services meet your requirements..
      </p>
      <br></br>
      <p>
        4.The contents of the Platform and the Services are proprietary to us
      ...
      <br></br>
      <p>
        5.You acknowledge that unauthorized use of the Platform and/or the
      ...
      <br></br>
      <p>
        7.You agree not to use the Platform and/ or Services for any purpose
      ...
      <br></br>
      <p>
        10.You shall indemnify and hold harmless Platform Owner, its affiliates,
        ...
        privacy Policy and other Policies, or Your violation of any law, rules
        or regulations or the rights (including infringement of intellectual
        property rights) of a third party.
      </p>
      <br></br>
      <p>
        11.Notwithstanding anything contained in these Terms of Use, the parties
      ...
      <p>
        ...
        be subject to the exclusive jurisdiction of the courts in Ranchi and
        Jharkhand.
      </p>
      <br></br>
      <p className="mb-3">
