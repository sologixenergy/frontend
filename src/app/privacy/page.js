...
const page = () => {
  return (
    ...
    <div className="border-gray-500 w-11/12 m-auto">
      <p className="font-bold text-2xl underline tracking-wider text-center">
        Privacy Policy
      </p>
      <h2 className="font-bold">Introduction</h2>
      <br></br>
      <p>
        This Privacy Policy describes how Sologix energy private limited and its
        affiliates (collectively " Sologix energy private limited, we, our, us")
        collect, use, share, protect or otherwise process your information/
        personal data through our website www.sologixenergy.com (hereinafter
      ...
      <br></br>
      <p>
        <span className="font-bold">Collection -</span>We collect your personal data when you use our Platform,
        ...
        person/association claiming to be Sologix energy private limited seeking
      ...
      <span className="font-bold">Usage -</span>
        Usage- We use personal data to provide the services you request. To the
        extent we use your personal data to market to you, we will provide you
        the ability to opt-out of such uses. We use your personal data to assist
        ...
        services, and updates; customise your experience; detect and protect us
        ...
        otherwise described to you at the time of collection of information. You
        understand that your access to these products/services may be affected
        in the event permission is not provided to us.
      </p>
      <br></br>
      <p>
      <span className="font-bold">Sharing -</span>
        ...
        access to the services and products offered by them. These entities and
        ...
        reward programs and other payment opted by you. These disclosure may be
      ...
      <br></br>
      <p>
      <span className="font-bold">Security Precautions -</span>
        To protect your personal data from unauthorised
        access or disclosure, loss or misuse we adopt reasonable security
        practices and procedures. Once your information is in our possession or
        whenever you access your account information, we adhere to our security
        guidelines to protect it against unauthorised access and offer the use
        of a secure server. However, the transmission of information is not
        completely secure for reasons beyond our control. By using the Platform,
      ...
      <br></br>
      <p>
      <span className="font-bold">Data Deletion and Retention -</span>
        You have an option to delete your account
        by visiting your profile and settings on our Platform , this action
        would result in you losing all information related to your account. You
        may also write to us at the contact information provided below to assist
        you with these requests. We may in event of any pending grievance,
        claims, pending shipments or any other services we may refuse or delay
        deletion of the account. Once the account is deleted, you will lose
        access to the account. We retain your personal data information for a
        ...
        fraud or future abuse or for other legitimate purposes. We may continue
      ...
      <p className="mb-1">Insert Name of the Office:</p>
      <p className="mb-1">Designation</p>
      <p className="mb-1">Insert Name and Address of the Company:</p>
      <p className="mb-1">Contact us:</p>
      <p className="mb-3">Phone: Time: Monday - Friday(9:00 - 18:00)</p>
      </div>
    </div>
  );
};
